This is an outstanding example of **Proactive Threat Hunting**. 

Instead of waiting for an antivirus alert on the endpoint, you took a piece of Cyber Threat Intelligence (CTI) about adversary infrastructure setup, hunted for it in your environment, and caught a live phishing campaign. *This is exactly what advanced SOC Analysts do.*

Here is the official report for your portfolio, formatted using the updated template. I added a "Deep Dive" section to explain *why* attackers change MX records on typosquatted domains, which will demonstrate deep DNS and email protocol knowledge to hiring managers.

---

# SOC326 - Impersonating Domain MX Record Change Detected — Case #304
...
<img width="455" height="346" alt="image" src="https://github.com/user-attachments/assets/3ae39c0f-c08c-4930-a5dd-cf845a408186" />
...
<img width="600" height="300" alt="image" src="[INSERT SCREENSHOT: CTI report showing letsdefwnd.io and mail.mailerhost.net]" />
...
<img width="800" height="300" alt="image" src="[INSERT SCREENSHOT: Email Security showing the 'voucher' email from letsdefwnd.io]" />
...
<img width="800" height="200" alt="image" src="[INSERT SCREENSHOT: EDR Browser History showing mateo navigating to letsdefwnd.io]" />
...
<img width="800" height="200" alt="image" src="[INSERT SCREENSHOT: EDR Network Action showing connection to 45.33.23.183]" />
